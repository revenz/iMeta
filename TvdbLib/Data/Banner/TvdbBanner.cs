...
namespace TvdbLib.Data
{
  ...
  public class TvdbBanner
  {
    ...
    /// <summary>
    /// Gets or sets the number of ratings cast for this banner
    /// </summary>
    public int RatingCount { get { return m_ratingCount; } set { m_ratingCount = value; } }

    /// <summary>
    /// Gets or sets the rating of this banner
    /// </summary>
    public double Rating { get { return m_rating; } set { m_rating = value; } }
