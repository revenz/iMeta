    ...
    internal List<TvdbBanner> ExtractBanners(String _data)
    {
      ...
      var allFanartBanners =  from banner in xml.Descendants("Banner")
                              ...
                              select new TvdbFanartBanner
                              {
                                ...
                                Rating = banner.Element("Rating") != null ? Util.DoubleParse(banner.Element("Rating").Value) : 0,
                                RatingCount = banner.Element("RatingCount") != null ? Util.Int32Parse(banner.Element("RatingCount").Value) : 0
                              };
